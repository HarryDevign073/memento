...
import { BookText, Trash, Edit, Heart, MoreHorizontal, Play } from "lucide-react";
...
const ListQuizItem = ({
	...
	return (
		...
		>
			{isActive ? (
				// Active State
				<div className="relative w-full h-[100px] md:h-full md:w-[102px] rounded-md flex items-center justify-center purple-bg-gradient flex-shrink-0">
					<BookText color="white" />
					{state === "edit" && (
						<div className="block md:hidden absolute bottom-2 left-2">
							{/* Status Badge */}
				...
				// Inactive State
				<div className="relative w-full h-[100px] md:h-full md:w-[102px] rounded-md flex items-center justify-center bg-neutral-300 flex-shrink-0">
					<BookText color="white" />
					{state === "edit" && (
						<div className="block md:hidden absolute bottom-2 left-2">
							{/* Status Badge */}
